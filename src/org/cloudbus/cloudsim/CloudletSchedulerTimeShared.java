...
public class CloudletSchedulerTimeShared extends CloudletScheduler {
	...
	public double updateVmProcessing(double currentTime, List<Double> mipsShare) {
		...
		for (ResCloudlet rcl : getCloudletExecList()) {
			...
			// System.out.println(getTotalCurrentAllocatedMipsForCloudlet(rcl,
			// getPreviousTime()));
			// OLA System.out.println(CloudSim.clock()+ " : Remaining length of tuple ID
			// "+((Tuple)rcl.getCloudlet()).getActualTupleId()+" =
